...
def process_image(image_path):
    ...
    for contour in contours:
        ...
        if area >= 2000 and w/h >= 1:
            ...
            print("w/h", w/h)
            # Save the ROI_V1
            roi_filename = os.path.splitext(os.path.basename(image_path))[0] +f'_idx_{idx}_'+ os.path.splitext(os.path.basename(image_path))[0][idx]+'__roi.png'
